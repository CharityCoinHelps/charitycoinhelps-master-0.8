...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CharityCoinHelps " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"charitycoinhelps.org", "charitycoinhelps.org"},
    {"charitycoinhelps.com", "charitycoinhelps.com"},
    {"charitycoinhelps.net", "charitycoinhelps.net"},
    {"charitycoinhelps.info", "charitycoinhelps.info"},
    {"dnsseed.charitycoinhelps.org", "dnsseed.charitycoinhelps.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"charitycoinhelpstools.com", "testnet-seed.charitycoinhelpstools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CharityCoinHelps is probably already running."), addrBind.ToString().c_str());
        else
